...
//   const va1 = version1.split(".").map((item) => parseInt(item));
//   const va2 = version2.split(".").map((item) => parseInt(item));

//   let i = 0;
//   while (va1[i] !== undefined || va2[i] !== undefined) {
//     const v1 = va1[i] || 0;
//     const v2 = va2[i] || 0;
//     if (v1 > v2) {
//       return 1;
...
var compareVersion = function (version1, version2) {
  ...
  while (c1 < len1 || c2 < len2) {
    ...
    while (c1 < len1 && version1[c1] !== ".") {
      const preIsZero = v1 === "" && version1[c1] === "0";
      if (!preIsZero) {
        v1 += version1[c1];
      }
      c1++;
    ...
    while (c2 < len2 && version2[c2] !== ".") {
      const preIsZero = v2 === "" && version2[c2] === "0";
      if (!preIsZero) {
        v2 += version2[c2];
      }
      c2++;
